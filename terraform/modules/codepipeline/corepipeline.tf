...
resource "aws_codebuild_project" "devopschallenge_build" {
  name          = "devopschallenge-codebuild"
  build_timeout = "10"
...
resource "aws_codepipeline" "pipeline" {
  ...
  stage {
    ...
    action {
      ...
      configuration {
        ProjectName = "devopschallenge-codebuild"
      }
    }
  }
